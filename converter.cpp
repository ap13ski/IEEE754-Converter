...
std::string Converter::TrimZerosScientific(const std::string& str_input)
{
	...
	for (int j = 0; j < pos_left; ++j)
		{ str_stream << str_input[j]; }
	for (int j = pos_right; j < str_input.length(); ++j)
		{ str_stream << str_input[j]; }
...
{
	Converter::results.valueSingleBinarySign = STR_EMPTY;
	Converter::results.valueSingleBinaryExponent = STR_EMPTY;
	Converter::results.valueSingleBinaryMantissa = STR_EMPTY;
	Converter::results.valueSingleBinaryTotal = STR_EMPTY;
	Converter::results.valueSingleHex = STR_EMPTY;
	Converter::results.valueSingleExactTrimmed = STR_EMPTY;
	Converter::results.valueSingleScientificTrimmed = STR_EMPTY;
}

//===============================================
void Converter::NullifyDouble()
{
	Converter::results.valueDoubleBinarySign = STR_EMPTY;
	Converter::results.valueDoubleBinaryExponent = STR_EMPTY;
	Converter::results.valueDoubleBinaryMantissa = STR_EMPTY;
	Converter::results.valueDoubleBinaryTotal = STR_EMPTY;
	Converter::results.valueDoubleHex = STR_EMPTY;
	Converter::results.valueDoubleExactTrimmed = STR_EMPTY;
	Converter::results.valueDoubleScientificTrimmed = STR_EMPTY;
}
...
void Converter::CalculateResults(const std::string& str_value)
{
	...
	{
		Converter::results.status = false;
	}
}
